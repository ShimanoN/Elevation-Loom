...
function runISOWeekTests(): void {
  ...
  console.assert(
    test1.iso_year === 2026,
    `FAIL: 2025-12-29 year expected 2026, got ${test1.iso_year}`
  );
  console.assert(
    test1.week_number === 1,
    `FAIL: 2025-12-29 week expected 1, got ${test1.week_number}`
  );
  ...
  console.assert(
    test2.iso_year === 2026,
    `FAIL: 2026-02-05 year expected 2026, got ${test2.iso_year}`
  );
  console.assert(
    test2.week_number === 6,
    `FAIL: 2026-02-05 week expected 6, got ${test2.week_number}`
  );
  console.assert(
    test2.start_date === '2026-02-02',
    `FAIL: 2026-02-05 start_date expected 2026-02-02, got ${test2.start_date}`
  );
  console.assert(
    test2.end_date === '2026-02-08',
    `FAIL: 2026-02-05 end_date expected 2026-02-08, got ${test2.end_date}`
  );
